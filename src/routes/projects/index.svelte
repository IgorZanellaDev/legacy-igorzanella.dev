...
<div class="p-2">
	...
	<div class="w-full flex flex-col items-center justify-center">
		{#each projects as project}
			<a href="/projects/{project.slug}" class="bg-light w-5/6 m-2 rounded-lg">
				<img class="rounded-t-lg object-cover w-full h-48 object-center" src="img/projects/{project.image}" alt={project.title}/>
				<div class="p-3">
